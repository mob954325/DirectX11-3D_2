...
#pragma once
#include <pch.h>
#include <VertexTypes.h>        // https://github.com/microsoft/DirectXTK/wiki/VertexTypes
#include <PrimitiveBatch.h>     // https://github.com/microsoft/DirectXTK/wiki/PrimitiveBatch
