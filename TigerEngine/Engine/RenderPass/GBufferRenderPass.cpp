...
void GBufferRenderPass::Init(ComPtr<ID3D11Device> &device, ComPtr<ID3D11DeviceContext>& deviceContext,  UINT width, UINT height)
{
...
void GBufferRenderPass::SetDepthStencilView(ComPtr<ID3D11DepthStencilView> &dsv)
{
...
void GBufferRenderPass::CreateGBuffers(ComPtr<ID3D11Device> &device)
{
